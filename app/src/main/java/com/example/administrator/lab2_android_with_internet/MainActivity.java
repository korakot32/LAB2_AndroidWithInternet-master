package com.example.administrator.lab2_android_with_internet;
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    TextView countryText = (TextView) findViewById(R.id.textView);
                    ...
                    TextView pressureText = (TextView) findViewById(R.id.textView2);
                    pressureText.setText(pressure);

                    //humidity
                    String humidity = mainObj.getString("humidity");

                    TextView humidityText = (TextView) findViewById(R.id.textView3);
